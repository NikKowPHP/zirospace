...
export function Footer() {
  ...
  const organizationJsonLd = {
    ...
    description:
      'Digital health solutions provider specializing in medical software development and healthcare technology innovation.',
    address: {
      '@type': 'PostalAddress',
  ...
  return (
    <>
      <footer
        className="bg-gray-50 max-w-5xl mx-auto rounded-primary-lg py-12 px-2 sm:py-18 sm:px-20"
        itemScope
      ...
      >
        <div className="max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  <span itemProp="name">
                    ul. Mogilska 43, 31-545 Kraków, Poland
                  </span>
                </p>
              </div>
          ...
          <meta
            itemProp="keywords"
            content="digital health solutions, healthcare software development, medical app design, health tech UI/UX, patient experience design"
          />
        </div>
      </footer>
