...
const StarRatingInput: React.FC<StarRatingInputProps> = ({ rating, onRatingChange, disabled, maxRating = 5 }) => {
        ...
        return (
          <svg
            ...
            className={`w-6 h-6 cursor-pointer ${
              (hoveredRating || rating || 0) >= starValue ? 'text-yellow-500' : 'text-gray-300'
