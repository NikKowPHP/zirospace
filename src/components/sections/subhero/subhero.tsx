...
export const SubheroSection = async () => {
  ...
  return (
    ...
    >
      <section
        className="flex flex-col  items-center text-center py-[100px]  sm:py-[100px]"
        itemScope
        itemType="https://schema.org/WebPageElement"
      >
        <div className="flex flex-col items-center text-center max-w-5xl gap-[20px] sm:gap-[32px]">
          <h1
