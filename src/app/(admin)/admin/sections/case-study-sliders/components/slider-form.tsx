        ...
        {images.map((image, index) => (
          <div key={image.id} className="space-y-2 border rounded-md p-4">
            <div className="flex justify-between items-center">
              ...
              <Button variant="secondary" onClick={() => handleRemoveImage(index)}>
                Remove
              </Button>
            </div>
            <div>
              <label htmlFor={`image-${index}-image`} className="block text-sm font-medium text-gray-700">
                Image URL
              </label>
              <input
                type="url"
            ...
            <div>
              <label htmlFor={`image-${index}-alt`} className="block text-sm font-medium text-gray-700">
                Image Alt Text
              </label>
              <input
                type="text"
